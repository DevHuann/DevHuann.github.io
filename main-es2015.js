...
function AboutComponent_div_13_div_1_Template(rf, ctx) { if (rf & 1) {
...
function AboutComponent_div_14_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
class AboutComponent {
    ...
    startTyping() {
        setInterval(() => {
            ...
            this.textToShow = currentWord.slice(0, this.characterIndex); // Sử dụng textToShow thay vì thay đổi DOM
...
AboutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AboutComponent, selectors: [["app-About"]], decls: 17, vars: 3, consts: [[1, "about-top"], [1, "text-center", 2, "letter-spacing", "10px", "display", "flex", "flex-direction", "column", "justify-content", "space-around"], [1, ""], [1, "about-content"], [1, "row", "ml-1"], [1, "col-md-7"], [1, "ml-2", "row", "align-items-end", 2, "height", "30%"], [2, "color", "blue", "margin-top", "20px"], [2, "height", "70%"], [4, "ngFor", "ngForOf"], [1, "col-md-5"], ["src", "./assets/images/about.svg", 1, "img-fluid", "about-svg"], [4, "ngIf"], [1, "skill-box"]], template: function AboutComponent_Template(rf, ctx) { if (rf & 1) {
...
ContactComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ContactComponent, selectors: [["app-Contact"]], decls: 32, vars: 0, consts: [[1, "row", "ml-1"], [1, "col"], [1, "testimonial-card"], ["src", "../assets/images/Contact.svg", 1, "img-fluid", "contact-image"], [1, "row"], [1, "col-md-2"], [1, "contact-card"], [1, "form-group"], [1, "mb-3"], [1, "input-group", "mb-4"], [1, "input-group-prepend"], [1, "input-group-text"], [1, "fa", "fa-user", "text-info"], ["type", "text", "id", "FullName", "placeholder", "Full Name", 1, "form-control"], [1, "fa", "fa-envelope", "text-info"], ["type", "email", "id", "Email", "placeholder", "test@gmail.com", 1, "form-control"], [1, "fa", "fa-comment", "text-info"], ["placeholder", "Your Message", 1, "form-control"], [1, "text-center"], ["type", "submit", "value", "Send", 1, "btn", "btn-info", "btn-block", "rounded-0", "py-2"]], template: function ContactComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 1);
...
function ProfileComponent_img_1_Template(rf, ctx) { if (rf & 1) {
...
function ProfileComponent_i_31_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "i", 23);
} }
function ProfileComponent_i_33_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "i", 24);
} }
function ProfileComponent_i_35_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "i", 25);
} }
function ProfileComponent_i_37_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "i", 26);
} }
function ProfileComponent_i_39_Template(rf, ctx) { if (rf & 1) {
...
function ResumeComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
...
ResumeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ResumeComponent, selectors: [["app-Resume"]], decls: 11, vars: 2, consts: [[1, "row", "middle-line"], [1, "col", "ml-3"], ["src", "./assets/images/Experience.svg", 1, "img-fluid", "float-right"], [1, "resume-title", "text-center"], [4, "ngFor", "ngForOf"], [1, "col"], ["src", "../assets/images/education.svg", 1, "img-fluid", "float-left"], [1, "resume-card"], [1, "resume-card-title"], ["aria-hidden", "true", 1, "fa", "fa-building", "resume-icon"], [2, "margin", "1px !important"], [1, "mb-auto"], ["aria-hidden", "true", 1, "fa", "fa-graduation-cap", "resume-icon"]], template: function ResumeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 1);
...
function ServicesComponent_div_2_div_1_Template(rf, ctx) { if (rf & 1) {
...
function ServicesComponent_div_5_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "strong", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](2, "i", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](3);
...
ServicesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ServicesComponent, selectors: [["app-Services"]], decls: 7, vars: 2, consts: [[1, "row", "mt-3"], [1, "col"], [4, "ngFor", "ngForOf"], ["src", "./assets/images/Design_Thinking.svg", 1, "img-fluid", "service-image"], ["src", "./assets/images/Skill.svg", 1, "img-fluid", "service-image"], ["class", "service-card ", 4, "ngIf"], [1, "service-card"], [1, "service-card-title"], ["aria-hidden", "true", 1, "fa", "fa-chevron-circle-right", "service-icon"], [2, "margin", "3px !important"], [1, "mb-auto"], ["class", "service-card", 4, "ngIf"]], template: function ServicesComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 1);
...
TestimonialsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TestimonialsComponent, selectors: [["app-Testimonials"]], decls: 6, vars: 1, consts: [[1, "row", "ml-1"], [1, "col", "d-flex", "flex-row", "flex-wrap", 2, "justify-content", "space-evenly"], [4, "ngFor", "ngForOf"], [1, "row"], [1, "col"], ["src", "./assets/images/Skill.svg", 1, "img-fluid", "testimonial-image"], [3, "href"], [1, "testimonial-card"], [1, "testimonial-text", 2, "float", "left"], ["aria-hidden", "true", 1, "fa", "fa-quote-left", "mr-2"], ["aria-hidden", "true", 1, "fa", "fa-quote-right", "ml-2"], [1, "testimonial-text", 2, "float", "right"]], template: function TestimonialsComponent_Template(rf, ctx) { if (rf & 1) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 15, vars: 0, consts: [[1, "row", "d-flex", "vh-100", "align-items-center", 2, "margin-bottom", "-20px"], [1, "col"], [1, "col-md-2"], [1, "card"], [1, "card-body", "align-self-center", 2, "height", "700px"], [1, "col-md-5"], [2, "min-height", "700px !important", "background-color", "#ffffff", "height", "700px"], [1, "d-flex", "justify-content-center", "mb-10"], ["href", "https://github.com/DevHuann", "target", "blank", 1, "bg-light", "text-black", "lead", 2, "text-decoration", "none", "padding", "1px", "font-size", "11px", "border", "1px solid black", "border-radius", "2px"], ["aria-hidden", "true", 1, "fa", "fa-github"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, directives: [_Profile_Profile_component__WEBPACK_IMPORTED_MODULE_1__["ProfileComponent"], _Nav_Nav_component__WEBPACK_IMPORTED_MODULE_2__["NavComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5jb21wb25lbnQuY3NzIn0= */"] });
...
/* harmony import */ var _Resume_Resume_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Resume/Resume.component */ "./src/app/Resume/Resume.component.ts");
...
/* harmony import */ var _Testimonials_Testimonials_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Testimonials/Testimonials.component */ "./src/app/Testimonials/Testimonials.component.ts");
...
const AppRoutes = [
    ...
    { path: "testimonials", component: _Testimonials_Testimonials_component__WEBPACK_IMPORTED_MODULE_2__["TestimonialsComponent"] },
    ...
    { path: "resume", component: _Resume_Resume_component__WEBPACK_IMPORTED_MODULE_0__["ResumeComponent"] },
    { path: "**", component: _About_About_component__WEBPACK_IMPORTED_MODULE_4__["AboutComponent"], pathMatch: "full" },
];
...
const Skills = [
    'C#', '.Net Core', 'Angular', 'Asp.Net', 'Typescript', 'Javascript', 'Java'
];
// Max skills limit is 6 . If you add more than 6 skill , you may be disappointed.
const JobExperience = [
    { company: 'WEB DEVELOPMENT', rank: '', date: ' ', description: 'My team design and program website and mobile application according to customer requirements.' },
    { company: 'WEB DESIGN', rank: '', date: '', description: 'My team design and program website and mobile application according to customer requirements.' },
];
// Max job experiences limit is 3 . If you add more than 3 skill , you may be disappointed.
const Education = [
    { school: 'SaoDo University', date: '09/2020 - Present', description: 'University course 11 Information Technology 1.' },
    { school: 'Khuc Thua Du High School', date: '09/2017 - 07/2020', description: 'DK18 Khuc Thua Du High School.' },
];
// Max education limit is 3 . If you add more than 3 skill , you may be disappointed.
const Services = [
    { serviceName: 'Web Design', description: '' },
    { serviceName: 'Desktop Development', description: '' },
    { serviceName: 'Software Architecture', description: '' },
    { serviceName: 'Social Media Management', description: '' },
    { serviceName: 'Logo Design', description: '' }
];
// Max services limit is 6 . If you add more than 6 skill , you may be disappointed.
const Testimonials = [
    { date: '3/2022', category: 'Website', description: 'First personal website using angular framework.', bg: './assets/images/bg_achievement/3_2022.png', review: 85, url: 'https://phanvanhuan.com' },
    { date: '7/2023', category: 'Website', description: 'SaoDo 360 - Scientific research project at SaoDo University achieved excellent results.', bg: './assets/images/bg_achievement/7_2023.png', review: 80, url: 'http://phanvanhuan.lovestoblog.com' },
];
...
module.exports = __webpack_require__(/*! C:\Users\DELL\WebstormProjects\angular-dev-portfolio\src\main.ts */"./src/main.ts");
